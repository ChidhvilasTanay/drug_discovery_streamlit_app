...
def filedownload(df):
    ...
    href = f'<a href="data:file/csv;base64,{b64}" download="prediction.csv">Click here to download your Predictions</a>'
    return href
...
if st.sidebar.button('Predict'):
    ...
    Xlist = list(pd.read_csv('descriptor_list_coronavirus2.csv').columns)
